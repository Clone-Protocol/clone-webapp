...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        <title>Clone App - Cloned Assets to Supercharge your Portfolio</title>
        ...
        <meta property="og:title" content="Clone App - Cloned Assets to Supercharge your Portfolio" />
        <meta property="og:url" content="https://clone.so/" />
